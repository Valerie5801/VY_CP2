...
3. Input Depth value (1-5)
4. Input color (can use either words, rgb tuple, or hexadecimal)
5. The turtle window should appear with your triangle. When you are done viewing, press enter to hide it.
