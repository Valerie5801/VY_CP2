...
def window():
    ...
    project_one = tk.Button(root, text="Sierpinski Triangle Generator", command=lambda: show_desc("project_one", info_box), font=("Georgia", 15), width=12, height=2)
    ...
    project_three = tk.Button(root, text="Simple Gradebook", command=lambda: show_desc("project_three", info_box), font=("Georgia", 15), width=12, height=2)
