...
project_info = {
    ...
    "project_two": "This project lets users create four different shapes: rectangles, squares, circles, and triangles. It lets users choose the size of the shapes, compare shapes, view shapes, scale shapes, and it saves shapes between runs.\n\nWhat I learned:\nHow to use classes for organization and readability of code\n-How to save object/class information in a CSV\n\nProgramming Challenges Overcome:\n-Proper formatting so class information will save to a CSV\n-Making an intuitive UI",
