...
project_info = {
    "project_one": "This project generates a sierpinski triangle based \non the user's choice of color and depth.\n\nWhat I learned:\n-How to use recursion for shorter, easier to read code\n-How to use turtle to check available colors\n\nProgramming Challenges Overcome:\nRecursion logic\n-Sanitizing user inputs",
    "project_two": "This project lets users create four different shapes: rectangles, squares, circles, and triangles. \nIt lets users choose the size of the shapes, compare shapes, view shapes, scale shapes, and it saves shapes between runs.\n\nWhat I learned:\nHow to use classes for organization and readability of code\n-How to save object/class information in a CSV\n\nProgramming Challenges Overcome:\n-Proper formatting so class information will save to a CSV\n-Making an intuitive UI",
    "project_three": "This project lets users add, remove, view, and edit students \ninto the gradebook, as well as view the whole class.\n\nWhat I learned:\nAggregating classes and utilizing child and parent classes\n\nProgramming Challenges Overcome:\nManaging information and data/CSV saving\nFiguring out how to get the searching function to work",
    "project_four": "This project lets users type words into a document, view that document, update the document \nfile path in case they change the file they want to look at (must be a .txt file), and rewrite document (which replaces all existing info in the document with new info).\n\nWhat I learned:\nHow to use both a text document and a CSV document to save information\n\nProgramming Challenges Overcome:\n-Figuring out how to use the text document and CSV document to save any changes the user made" 
}
